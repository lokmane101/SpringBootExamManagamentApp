...
<div class="container">
    ...
    <f:form action="${pageContext.request.contextPath}/examen/UpdateExam" method="POST" modelAttribute="examenModel">
            ...
            <div class="col">
                ...
                <select name="selectedSalle" id="selectedSalle" class="form-control" multiple required>
                    <c:forEach items="${salleList}" var="s">
                        <option value="${s.nomSalle}" <c:if test="${fn:contains(selectedSallesForCurrentExam, s.nomSalle)}">selected</c:if>>
        ...
        <div class="row">
            <div class="col">
                <label for="selectedTypeExamen">Type Examen</label>
        ...
        <div class="row">
            <div class="col">
                ...
                <f:input path="dureePrevue" type="text" class="form-control" required="required" placeholder="H:mm"
                    pattern="([1-9]):[0-5][0-9]" title="Veuillez entrer un format d'heure valide (H:mm)" />
        ...
        <div class="row">
            <div class="col">
                ...
                <f:input path="heureDeDebut" type="text" class="form-control" placeholder="HH:mm" required="required"
                    pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]" title="Veuillez entrer un format d'heure valide (HH:mm)" />
